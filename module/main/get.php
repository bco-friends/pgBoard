...
function status_get()
{
  ...
  // Temporarily commented out: sequential scan in thread_member with no usable index leads to long query times.
  // Needs a partial index on thread_member WHERE ignore IS TRUE before it can be restored.
  // $DB->query("SELECT
  //               count(*) as num,
