...
class Search
{
    ...
    function message_insert($data, $id)
    {
        return true;
    }
    function message_post_insert($data, $id)
    {
        return true;
    }
    ...
    function message_post_update($data)
    {
        return true;
    }
    ...
    function message_post_delete($id)
    {
        return true;
    }
}
